...
import com.nutrisysteam.nutrisys.databinding.FragmentExercise2Binding
...
class Exercise2Fragment : Fragment() {
    ...
    companion object {
        private const val EXERCISE_TWO = "EXERCISE_TWO"
        private const val CATEGORY = "CATEGORY"
        fun newInstance(data: String,category: String): Exercise2Fragment {
            val fragment = Exercise2Fragment()
            val args = Bundle()
            args.putString(EXERCISE_TWO, data)
    ...
    override fun onCreateView(
        ...
        val id: String? = arguments?.getString(EXERCISE_TWO)
        ...
        if(data == null) {
            ...
            Glide.with(this@Exercise2Fragment)
                .load(data.URL_1)
